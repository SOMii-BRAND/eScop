...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;95m[●●] \x1b[1;92m●LOGIN ●WITH● FACEBOOK●\x1b[1;95m[●●]' )
		id = raw_input('\033[1;95m[(¯ｰ¯)] \x1b[1;94mID/Email● \x1b[1;91m: \x1b[1;94m')
		pwd = raw_input('\033[1;96m[(¯ｰ¯)] \x1b[1;95mPassword●\x1b[1;91m: \x1b[1;96m')
		tik()
		try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.Facebook.somi awan')
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print 42*"\033[1;96m="
		jalan('\033[1;96m[✺] \033[1;94mLoading..IDs \033[1;97m...')
	...
	jalan('\033[1;96m[✺] \033[1;92mStarting With Somi\033[1;97m...')
	titik = ['.   ','..  ','... ']
	for o in titik:
